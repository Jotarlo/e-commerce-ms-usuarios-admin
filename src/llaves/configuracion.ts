export namespace Configuracion {
  ...
  export const mensajeCambioClave = "Su contraseña ha sido actualizada correctamente. Si no ha sido ustyed, por favor la puede recuperar con su correo electrónico en el sistema de información."
  ...
  export const mensajeRecuperarClave = "Su nueva clave aleatoria es ";
  ...
  export const url_validar_token = "http://localhost:5001/verificar-token"
